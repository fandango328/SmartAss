    ...
    try:
        ...
        try:
            ...
            try:
                ...
                input_cost, output_cost = token_tracker.update_session_costs(
                    input_count, 
                    output_count, 
            ...
            if tool_results:
                ...
                try:
                    ...
                    try:
                        ...
                        input_cost, output_cost = token_tracker.update_session_costs(tool_input_count, tool_output_count, True)
                        # Can use these values if needed, or just ignore them with _ variables
                    except Exception as token_err:
