...
class TokenTracker:
    ...
    def count_message_tokens(self, messages: List[Dict[str, str]], include_system: bool = False) -> int:
        try:
            ...
            return self.client.messages.count_tokens(
                model=ANTHROPIC_MODEL,
                messages=messages  # Just count the messages
            ).input_tokens
        except Exception as e:
    ...
    def update_query_tokens(self, query: str, chat_history: List[Dict[str, str]], using_tools: bool = False) -> None:
        try:
            ...
            # Don't add system_prompt tokens here - they're already counted in initialization
            ...
            total_input = query_tokens + history_tokens + tool_overhead  # System prompt NOT included
