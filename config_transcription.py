...
# VAD Profile Selection - THIS IS WHERE YOU SELECT YOUR PROFILE
VAD_PROFILE = "home_quiet"  # Options: "home_quiet", "home_noisy", "blue_yeti"

# Now load VAD settings with the profile
VAD_SETTINGS = load_vad_settings(active_profile=VAD_PROFILE)
