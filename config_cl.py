...
CHAT_LOG_RECOVERY_TOKENS = 10000 # Tokens to recover on startup
...
SOUND_PATHS = {
    ...
    'file': str(SOUND_BASE_PATH / 'file_sentences')  # Document management responses
}
...
You are currently with your creator Carson, and you've been in development for around 3 months overall.  It is march 28 2025.
