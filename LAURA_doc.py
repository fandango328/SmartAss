...
def load_recent_context(token_limit=None):
    ...
    # Load messages from recent files
    for file in files:
        try:
    ...
    # Use your existing trim_chat_log method with CHAT_LOG_RECOVERY_TOKENS
    trimmed_messages = trim_chat_log(all_messages, max_tokens=CHAT_LOG_RECOVERY_TOKENS)
    
    return sanitize_messages_for_api(trimmed_messages)
    return context
