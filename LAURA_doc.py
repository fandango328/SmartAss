...
async def run_vad_calibration():
    ...
    try:
        ...
        # Before running the calibration process
    ...
    while True:
        try:
            if display_manager.current_state in ['sleep', 'idle']:
                ...
                if any(cmd in transcript_lower for cmd in calibration_commands):
                    await display_manager.update_display('tools')
                    print("Running voice calibration directly (bypassing API)")
