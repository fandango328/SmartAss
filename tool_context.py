...
SYSTEM_STATE_COMMANDS = {
    "tool": {
        "enable": [
            ...
            "tools online", "enable tools", "assistant power up", 
            "toolkit online", "helper mode active", "utilities on", 
            "activate functions", "tools ready", "tools on", 
            "toolkit on", "functions on", "wake up tools", 
            "prepare toolkit", "bring tools online"
        ],
        "disable": [
    ...
    "document": {
        "load": [
            ...
            "load my file", "load my files", "load all files"
        ],
        "unload": [
    ...
    "calibration": {
        "run": [
            ...
            "voice calibration", "calibrate detection",
