    ...
    async def execute_tool_with_feedback(self, tool_call, initial_response=None):
        ...
        Returns:
            dict: Package containing tool result for final API call
            {
                ...
                'result': str,          # Raw tool execution result
            }
        """
        try:
            ...
            audio_task = None
            tool_audio_path = f"/home/user/LAURA/sounds/{current_persona}/tool_execution/feedback"
            ...
            # Package result with tool ID from tool_call
            return {
