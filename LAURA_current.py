            ...
            if display_manager.current_state in ['sleep', 'idle']:
                ...
                if tool_enable_commands or tool_disable_commands:
                    ...
                    if response == "[CONTINUE]":
                        ...
                        # CRITICAL FIX: Don't use continue here!
                        # Instead, explicitly call conversation_mode() to wait for input
                        ...
                        if follow_up:
                            ...
                            # No input received during conversation mode
                            await display_manager.update_display('idle')
                            
                        # NOW use continue to skip the rest of processing
                        continue
