...
async def generate_response(query):
    ...
    try:
        ...
        # Initialize system content as a list for proper formatting
        system_content = []
        ...
        if document_manager and document_manager.files_loaded:
            ...
            # Start with the text system prompt
            system_content = [{
                "type": "text",
                "text": SYSTEM_PROMPT
            }]
            ...
            for filename, file_data in document_manager.loaded_files.items():
                ...
                if (isinstance(file_data, dict) and 
                    ...
                    'base64' in file_data):
                    # Add image content block after the text
            ...
            # If no documents, use simple text system prompt
            system_content = [{
                "type": "text",
                "text": SYSTEM_PROMPT
            }]
        ...
        print(f"System content blocks: {len(system_content)}")
